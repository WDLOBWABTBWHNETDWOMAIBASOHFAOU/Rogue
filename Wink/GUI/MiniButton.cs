...
namespace Wink
{
    ...
    {
        public override int Width { get { return (int)(sprite.Width * scale / 10); } }
        public override int Height { get { return (int)(sprite.Height * scale / 10); } }
        public override Rectangle BoundingBox { get { return new Rectangle(0, 0, Width, Height); } }
